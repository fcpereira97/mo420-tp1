...
int main (int argc, char *argv[])
{
	...
	vector<int> vertices_lambdas(n_vertices, 1);

	// Executes Kruskal algorithm for getting a minimum spanning tree
	kruskal(n_vertices, n_edges, &edges, &vertices_lambdas);
